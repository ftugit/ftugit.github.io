(function() {
  ...
  if (!window.rch) {
    Lampa.Utils.putScript(["http://smotretk.com/invc-rch.js"], function() {}, false, function() {
      if (!window.rch.startTypeInvoke)
        window.rch.typeInvoke('http://smotretk.com', function() {});
    }, true);
  }
  ...
  function rchRun(json, call) {
    if (typeof signalR == 'undefined') {
      Lampa.Utils.putScript(["http://smotretk.com/signalr-6.0.25_es5.js"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('http://smotretk.com/lite/withsearch'), function(json) {
  ...
  if (false) {
    if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1) {
      ...
      $.get('http://smotretk.com/player-inner/' + element.url);
      return;
    }
  ...
  function startPlugin() {
    window.smotrolet4k_plugin = true;
    var manifst = {
      type: 'video',
      version: '',
      name: 'смотреть в 4K!',
      ...
      onContextLauch: function onContextLauch(object) {
        resetTemplates();
        Lampa.Component.add('smotrolet4k', component);
  ...
  Lampa.Storage.listener.follow('change', function (event) {
              if (event.name == 'activity') {
               //   console.log('Lampa.Activity.active().component', Lampa.Activity.active().component)
                if (Lampa.Activity.active().component == 'smotrolet4k') {
  ...
  if (!window.smotrolet4k_plugin) startPlugin();
